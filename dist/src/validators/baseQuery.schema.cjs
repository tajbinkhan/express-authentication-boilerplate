...
var baseQuery_schema_exports = {};
__export(baseQuery_schema_exports, {
  BaseQuerySchema: () => BaseQuerySchema,
  createSortingSchemas: () => createSortingSchemas,
  limitSchema: () => limitSchema,
  searchSchema: () => searchSchema
});
module.exports = __toCommonJS(baseQuery_schema_exports);
...
0 && (module.exports = {
  BaseQuerySchema,
  createSortingSchemas,
  limitSchema,
  searchSchema
});
//# sourceMappingURL=baseQuery.schema.cjs.map