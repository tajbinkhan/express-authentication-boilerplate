...
var csrf_route_exports = {};
__export(csrf_route_exports, {
  csrfRouter: () => csrfRouter
});
module.exports = __toCommonJS(csrf_route_exports);
...
//# sourceMappingURL=csrf.route.cjs.map