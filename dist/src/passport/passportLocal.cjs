...
// src/passport/passportLocal.ts
var passportLocal_exports = {};
__export(passportLocal_exports, {
  default: () => passportLocal_default,
  localAuthentication: () => localAuthentication
});
module.exports = __toCommonJS(passportLocal_exports);
...
var passportLocal_default = import_passport.default.use(
...
var localAuthentication = (req, res, next) => {
  import_passport.default.authenticate("local", (err, user) => {
    ...
    req.login(user, (loginErr) => {
      ...
      connection_default.update(sessions).set({
        userId: user.id
      }).execute();
...
//# sourceMappingURL=passportLocal.cjs.map