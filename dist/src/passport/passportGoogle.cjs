...
var passportGoogle_exports = {};
__export(passportGoogle_exports, {
  default: () => passportGoogle_default
});
module.exports = __toCommonJS(passportGoogle_exports);
...
var passportGoogle_default = import_passport.default.use(
...
//# sourceMappingURL=passportGoogle.cjs.map