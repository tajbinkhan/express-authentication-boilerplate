...
var customSessionStore_exports = {};
__export(customSessionStore_exports, {
  default: () => DrizzleSessionStore
});
module.exports = __toCommonJS(customSessionStore_exports);
...
var DrizzleSessionStore = class extends import_express_session.Store {
  ...
  async touch(id, session, callback) {
    try {
      const expire = session.cookie.expires || new Date(Date.now() + sessionTimeout);
...
//# sourceMappingURL=customSessionStore.cjs.map