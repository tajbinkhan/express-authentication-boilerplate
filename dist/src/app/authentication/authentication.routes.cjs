...
var authentication_routes_exports = {};
__export(authentication_routes_exports, {
  authenticationRouter: () => authenticationRouter
});
module.exports = __toCommonJS(authentication_routes_exports);
...
//# sourceMappingURL=authentication.routes.cjs.map